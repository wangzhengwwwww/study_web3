 ...
 * @beta
 */
declare function status_2(deploymentDir: string, _artifactResolver?: Omit<ArtifactResolver, "getBuildInfo">): Promise<StatusResult>;
 ...
 * @beta
 */
export declare type VerifyResult = [ChainConfig, VerifyInfo] | [null, name: string];
